...
( 1, 'Exciting to see, after many years, serious work in enabling multithreading that takes advantage of multiple CPUs in a more effective way in Python. One step at a time: https://github.com/python/cpython/pull/116338', FALSE);

-- Création des commentaires de posts
INSERT INTO "post" ( "owner", "parent", "content", "is_draft") VALUES
(1, 6, 'Maybe use dataclasses?', FALSE),
(5, 7, 'Oh wow those are useful, good to know about them. But this implementation does allow me to have other parameters in the __init__ method that aren''t directly members themselves and rather contribute to the calculation of other members. Do data classes allow this in some way?', FALSE),
(2, 5, 'Thanks', FALSE);

-- Création des groupes utilisateurs
INSERT INTO "group" ("name", "owner", "is_public") VALUES
('Linux', 1, TRUE),
('Python', 1, TRUE),
('SQL', 1, TRUE),
('Bash', 1, TRUE),
...
INSERT INTO "post" ("owner", "group", "content") VALUES
(1, 1, 'Radion, an internet radio CLI client, written in Bash.'),
(1, 4, NULL),
(1, 5, 'Grosse faille de sécurité chez GCR cinéma !! Les utilisateurs ont fuités sur le web hier.');

-- Ajout de la pièce jointe image dans le post "Radion" du groupe "Linux"
INSERT INTO "attachment" ("owner", "type", "image") VALUES
(10, 'image', 'https://preview.redd.it/radion-an-internet-radio-cli-client-written-in-bash-v0-bf28wvpwjync1.png?auto=webp&s=5ea01b080358157f0d8b19962b541b742a89d9b0');

-- Création du lien de partage du post "Radion" dans le groupe "Bash"
INSERT INTO "attachment" ("owner", "type", "post") VALUES
(11, 'post', 10);
